...
export class FerriteQLCompletionProvider implements vscode.CompletionItemProvider {
    provideCompletionItems(
        ...
        const ferriteCommands: Array<{ cmd: string; detail: string }> = [
            ...
            // Mnemo — Agentic Memory
            { cmd: 'MEM.PUT', detail: 'Store a memory record' },
            { cmd: 'MEM.GET', detail: 'Retrieve a memory record' },
            { cmd: 'MEM.RECALL', detail: 'Semantic recall across memories' },
            { cmd: 'MEM.FORGET', detail: 'Delete a memory record' },
            { cmd: 'MEM.STATS', detail: 'Get memory store statistics' },
            { cmd: 'MEM.SAVE', detail: 'Persist memory state to disk' },
            { cmd: 'MEM.LOAD', detail: 'Load memory state from disk' },
            { cmd: 'MEM.HELP', detail: 'Show Mnemo command help' },
            // Forge — Stored Functions
            { cmd: 'FN.LOAD', detail: 'Load a stored function module' },
            { cmd: 'FN.CALL', detail: 'Call a stored function' },
            { cmd: 'FN.CALL_RO', detail: 'Call a stored function (read-only)' },
            { cmd: 'FN.DROP', detail: 'Drop a stored function module' },
            { cmd: 'FN.LIST', detail: 'List loaded function modules' },
            { cmd: 'FN.STATS', detail: 'Get function execution statistics' },
            { cmd: 'FN.SHOW', detail: 'Show function source or metadata' },
            { cmd: 'FN.HELP', detail: 'Show Forge command help' },
            // Chronicle — Branching & Time-Travel
            { cmd: 'CHR.BRANCH', detail: 'Create a new branch' },
            { cmd: 'CHR.USE', detail: 'Switch to a branch' },
            { cmd: 'CHR.SET', detail: 'Set key in current branch' },
            { cmd: 'CHR.GET', detail: 'Get key from current branch' },
            { cmd: 'CHR.DEL', detail: 'Delete key in current branch' },
            { cmd: 'CHR.STATS', detail: 'Get branch statistics' },
            { cmd: 'CHR.SNAPSHOT', detail: 'Create branch snapshot' },
            { cmd: 'CHR.ROLLBACK', detail: 'Rollback branch to snapshot' },
            { cmd: 'CHR.SAVE', detail: 'Persist branch state to disk' },
            { cmd: 'CHR.LOAD', detail: 'Load branch state from disk' },
            { cmd: 'CHR.HELP', detail: 'Show Chronicle command help' },
            // Lucidity — Verifiable Audit Log
            { cmd: 'LUC.APPEND', detail: 'Append entry to audit log' },
            { cmd: 'LUC.DEL', detail: 'Mark audit log entry deleted' },
            { cmd: 'LUC.LEN', detail: 'Get audit log length' },
            { cmd: 'LUC.HEAD', detail: 'Get latest audit log entry' },
            { cmd: 'LUC.PROOF', detail: 'Generate Merkle proof for entry' },
            { cmd: 'LUC.SAVE', detail: 'Persist audit log to disk' },
            { cmd: 'LUC.LOAD', detail: 'Load audit log from disk' },
            { cmd: 'LUC.HELP', detail: 'Show Lucidity command help' },
            // Concord — CRDT Mesh
            { cmd: 'CON.GINC', detail: 'Increment G-Counter' },
            { cmd: 'CON.GVAL', detail: 'Get G-Counter value' },
            { cmd: 'CON.GMERGE', detail: 'Merge CRDT state from peer' },
            { cmd: 'CON.SAVE', detail: 'Persist CRDT state to disk' },
            { cmd: 'CON.LOAD', detail: 'Load CRDT state from disk' },
            { cmd: 'CON.HELP', detail: 'Show Concord command help' },
            // Pangea — Unified Storage
            { cmd: 'PNG.ALLOC', detail: 'Allocate storage block' },
            { cmd: 'PNG.READ', detail: 'Read from storage block' },
            { cmd: 'PNG.FREE', detail: 'Free storage block' },
            { cmd: 'PNG.STATS', detail: 'Get storage tier statistics' },
            { cmd: 'PNG.SAVE', detail: 'Persist storage metadata to disk' },
            { cmd: 'PNG.LOAD', detail: 'Load storage metadata from disk' },
            { cmd: 'PNG.HELP', detail: 'Show Pangea command help' },
        ];
